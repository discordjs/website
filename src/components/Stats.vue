    ...
    methods: {
      async fetch() {
        ...
        const [downloads, stars, contributors] = await Promise.all([
          fetch('https://api.npmjs.org/downloads/range/2013-08-21:2100-08-21/discord.js').then(json).catch(noop),
          fetch('https://api.github.com/repos/discordjs/discord.js').then(json).catch(noop),
          fetch('https://api.github.com/repos/discordjs/discord.js/stats/contributors').then(json).catch(noop),
        ]);
